...
$message = <<<'TXT'
    ...
    А новые приключения уже в разработке! Чтобы узнать, когда они будут, вы можете погадать у <a href="t.me/Tolyan_bot">Мадам Мистаро</a>, либо подписаться на мой канал и ждать новостей там: @shanginn_live
